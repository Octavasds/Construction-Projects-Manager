        ...
        while (true) {
            ...
            try {
                switch (choice) {
                    ...
                    case 10:
                        System.out.println("Create contract functionality not implemented yet.");
                        break;
                    ...
                    case 21:
                        System.out.println("Enter minimum start date (yyyy-mm-dd):");
                        Date minDate = Date.valueOf(scanner.nextLine());
                        List<Project> filteredProjects = projectController.filterProjectsByStartDate(minDate);
                        for (Project project : filteredProjects) {
                            System.out.println("- " + project.getName() + " (Start Date: " + project.getBeginDate() + ")");
                        }
                        break;
                    ...
                    case 22:
                        ...
                        boolean isOnSameProject = projectController.isClientAndEmployeeOnSameProject(
                                clientController.getAllClients().get(clientId),
                                employeeController.getAllEmployees().get(employeeId),
                                projectController.getAllProjects().get(projectId)
                        );
                        System.out.println("Are client and employee on the same project? " + isOnSameProject);
                        break;
